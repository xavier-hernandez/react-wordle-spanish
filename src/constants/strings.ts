...
export const WIN_MESSAGES = ['Â¡Buen trabajo!', 'Impresionante', 'Â¡Bien hecho!']
...
export const WRONG_SPOT_MESSAGE = (guess: string, position: number) =>
  `Debe usar ${guess} en la posiciÃ³n ${position}`
export const NOT_CONTAINED_MESSAGE = (letter: string) =>
  `Supongo que debe contener ${letter}`
export const ENTER_TEXT = 'Enter'
export const DELETE_TEXT = 'Delete'
export const STATISTICS_TITLE = 'EstadÃ­sticas'
export const GUESS_DISTRIBUTION_TEXT = 'DistribuciÃ³n de conjeturas'
